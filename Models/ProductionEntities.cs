...
public enum ProductionStatus { Pending, InProgress, Completed }
public enum AssignmentStatus { Pending, InProgress, Partial, Completed }
...
public sealed class Production : AuditableEntity
{
    ...
    public ICollection<ProductionProcess> Processes { get; set; } = new List<ProductionProcess>();
}
